...
export default function Dialog({ children}: DialogProps) {
  ...
  return (
    <dialog ref={dialogRef} className="fixed bg-gray-800 w-5/6 top-50 left-50 -translate-x-50 -translate-y-50 z-10 rounded-xl backdrop:bg-gray-800/80">
      <div className='w-full h-full'>
        <div>
          <button className="absolute z-10 right-0 mr-5 mt-2 text-white" onClick={closeDialog}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
