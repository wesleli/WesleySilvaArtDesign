...
export default function Relogio() {
    ...
    return <section id="conteudo-05" className="container mx-auto w-full" style={{backgroundImage, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat',}}>
                      ...
                      <button
                        onClick={() => router.push('/')}
                        className="text-lg bg-red-600 p-2 md:text-xl font-bold text-white left-4 md:left-8"
                    >
                        voltar
                    </button>
